    ...
    <>
      ...
      <main id="main" className="min-h-[50vh] bg-white py-12">
        <article className="mx-auto max-w-3xl px-4">
          <h1 className="text-3xl font-semibold text-asd-shark">Impressum</h1>
          ...
          <div className="mt-10 space-y-8 text-zinc-700">
            <section aria-labelledby="angaben">
              <h2 id="angaben" className="text-xl font-semibold text-asd-shark">
            ...
            <section aria-labelledby="vertretung">
              <h2 id="vertretung" className="text-xl font-semibold text-asd-shark">
                Vertreten durch
              </h2>
              <p className="mt-3">{siteConfig.managingDirector} (Geschäftsführung)</p>
            </section>
            <section aria-labelledby="kontakt-imp">
              <h2 id="kontakt-imp" className="text-xl font-semibold text-asd-shark">
                Kontakt
              </h2>
              <p className="mt-3">
                Telefon:{" "}
                <a className="text-amber-800 underline" href={siteConfig.phoneTel}>
            ...
            <section aria-labelledby="register">
              <h2 id="register" className="text-xl font-semibold text-asd-shark">
                Registereintrag
              </h2>
              <p className="mt-3">
            ...
            <section aria-labelledby="umsatzsteuer">
              <h2 id="umsatzsteuer" className="text-xl font-semibold text-asd-shark">
                Umsatzsteuer-ID
              </h2>
              <p className="mt-3">
            ...
            <section aria-labelledby="streitschlichtung">
              <h2 id="streitschlichtung" className="text-xl font-semibold text-asd-shark">
            ...
            <section aria-labelledby="haftung-inhalt">
              <h2 id="haftung-inhalt" className="text-xl font-semibold text-asd-shark">
                Haftung für Inhalte
              </h2>
              <p className="mt-3">
